...
//
//	go build -ldflags "\
//	  -X github.com/RoninForge/akashi/internal/version.version=v0.1.0 \
//	  -X github.com/RoninForge/akashi/internal/version.commit=$(git rev-parse HEAD) \
//	  -X github.com/RoninForge/akashi/internal/version.buildDate=$(date -u +%Y-%m-%dT%H:%M:%SZ)"
//
